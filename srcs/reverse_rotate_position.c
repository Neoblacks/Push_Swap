...
/*   Updated: 2023/02/08 20:06:07 by amugnier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_reverse_rotate_position(t_stack **stack) //good
{
	t_stack *tmp;
	t_stack *queue;
...
void	ft_do_rra(t_stack **stack_a) //good
{
	ft_reverse_rotate_position(stack_a);
	ft_printf("rra\n");
}

void	ft_do_rrb(t_stack **stack_b) //good
{
	ft_reverse_rotate_position(stack_b);
	ft_printf("rrb\n");
}

void	ft_do_rrr(t_stack **stack_a, t_stack **stack_b) //good
{
	ft_reverse_rotate_position(stack_a);
	ft_reverse_rotate_position(stack_b);
	ft_printf("rrr\n");
